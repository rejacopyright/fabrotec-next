    ...
    <>
      ...
      <div className='position-fixed bottom-0 w-100'>
        <div className='shadow-sm border-top border-gray-200 bg-white p-2'>
          <div className='row'>
            <Link href={`/issuer`} className='col text-center'>
              <KTSVG
                path={
              ...
              />
              <div
                className={`fs-9 lh-1 mt-1 text-${path?.startsWith(`/issuer`) ? 'primary' : 'dark'}`}>
                Issuer
              </div>
            </Link>
            <Link href={`/verifier`} className='col text-center'>
              <KTSVG
                path={
              ...
              />
              <div
                className={`fs-9 lh-1 mt-1 text-${path?.startsWith(`/verifier`) ? 'primary' : 'dark'}`}>
                Verifier
              </div>
            </Link>
          </div>
