  ...
  return (
    <div
      ...
      <div className='aside-footer flex-column-auto pt-5 pb-7 px-5' id='kt_aside_footer'>
        <Link className='btn btn-custom btn-primary w-100' href='/' target='_blank'>
          <span className='btn-label'>Lihat Website</span>
          <span className='svg-icon btn-icon svg-icon-2'>
            <KTSVG path='/media/icons/general/gen005.svg' />
          </span>
        </Link>
        <div className='text-center text-gray-500 fs-10px fw-bold mt-2px'>v1.0.4</div>
      </div>
      {/* end::Footer */}
    </div>
  )
