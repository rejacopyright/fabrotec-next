      ...
      <div
        ...
        {!aside?.display && (
          <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0'>
            <Link href='/' className='d-lg-none'>
              <img alt='Logo' src='/logo/logo.png' className='w-20px h-20px' />
            </Link>
          </div>
        )}
        {/* end::Logo */}
            ...
            {logoReplacement ? (
              ...
              <Link href='/' className='d-flex d-lg-none align-items-center flex-lg-grow-0'>
                {canMobilePageGoBack?.status ? (
                  ...
                  <img alt='Logo' src='/logo/logo.png' className='w-15px h-15px' />
                )}
              </Link>
            )}
          </>
        ...
        <div className='d-flex align-items-center flex-lg-grow-1 justify-content-between header-content'>
          <div className='d-flex flex-lg-grow-1 align-items-center'>
            {/* begin::Navbar */}
            <div className='header-left-xxx me-40px'>
              <Link href='/' className='d-none d-lg-flex flex-shrink gap-5px'>
                <Image src='/logo/logo.png' width={30} height={30} priority alt='' className='' />
                  ...
                  <div
                    ...
                    <Link
                      ...
                      className={clsx(menuClass, {
                        [activeClass]:
                          ['product'].includes(currentPath) ||
                          location?.pathname?.match(/(product)\/[a-zA-Z0-9]/gi) ||
                          location?.pathname === '/',
                      })}
                      href='/product'
                      scroll={false}>
