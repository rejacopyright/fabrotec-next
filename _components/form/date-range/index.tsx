...
export const customDayContent = (day: Date) => {
  return (
    <div>
      {isWeekend(day) && (
        <div
          className='position-absolute h-4px w-4px bg-danger radius-50'
          style={{ top: '5px', right: '5px', opacity: 0 }}
        />
      )}
    ...
    <div className='position-relative'>
      ...
      <div className='d-flex align-items-center py-16px px-24px gap-8px'>
        {btnToday && (
          <button
            type='button'
            className='btn btn-sm btn-flex flex-center bg-white tetx-dark fw-bolder fs-12px me-auto h-40px col text-nowrap'
        ...
        <button
          type='button'
          className='btn btn-sm btn-flex flex-center btn-white border border-gray-300 text-dark fw-bolder fs-12px h-40px col text-nowrap'
          onClick={onCancel}>
          Tutup
        </button>
        {btnReset && (
          <button
            type='button'
            className='btn btn-sm btn-flex flex-center btn-light-danger fw-bolder fs-12px h-40px col text-nowrap'
            onClick={onReset}>
            Reset
          </button>
        )}
        <button
          type='button'
          className='btn btn-sm btn-flex flex-center btn-primary fw-bolder fs-12px h-40px col text-nowrap'
          onClick={onSave}>
          Simpan
        </button>
      </div>
