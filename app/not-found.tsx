...
const Button: FC<any> = ({ home }) => {
  ...
  return (
    <div className=''>
      ...
      <button
        type='button'
        className='btn btn-flex btn-sm bg-gray-200 border border-gray-300 ps-4 pe-7 mx-2 radius-8'
        onClick={() => router.back()}>
...
export const Forbidden: FC<any> = ({ home }) => {
  return (
    <div
      className='d-flex align-items-center justify-content-center w-100'
      style={{ height: '60vh' }}>
      <div className='w-100 text-center'>
        <img alt='img' src='/media/assets/403.png' className={`h-100px h-lg-150px mb-10`} />
        <div className='fs-6 mb-10'>You are not allowed to access this page</div>
        <Button home={home} />
      </div>
    </div>
  )
