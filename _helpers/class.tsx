...
const classes: ClassesProps = {
  ...
  form: 'form-control form-control-sm form-control-solid bg-white text-dark fs-14px h-40px border border-dashed-xxx border-primary-xxx py-9px px-16px',
  textarea:
    'form-control form-control-sm form-control-solid bg-white text-dark fs-14px border py-9px px-16px',
